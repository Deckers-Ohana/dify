...
class EnterpriseMemberSSOOidcLogin(Resource):
    def get(self):
        parser = reqparse.RequestParser()
        parser.add_argument("app_code", type=str, required=True, location="args")
        parser.add_argument("redirect_url", type=str, required=True, location="args")
...
class EnterpriseMemberSSOOidcCallback(Resource):
    def get(self):
        parser = reqparse.RequestParser()
        parser.add_argument("state", type=str, required=True, location="args")
        parser.add_argument("code", type=str, required=True, location="args")
...
api.add_resource(EnterpriseMemberSSOOidcLogin, "/enterprise/sso/members/oidc/login")
api.add_resource(EnterpriseMemberSSOOidcCallback, "/enterprise/sso/members/oidc/callback")
